// vect3.cpp -- methods for the Vector class
#include "vect3.h" // include <iostream>
#include <cmath>
...
// reset vector from rectangular coordinates if form is RECT (the default) or
// else from polar coordinates if form is POL
